...
public class ProcessURLPOM {
	...
	public static WebElement doctorName(WebDriver d) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div/div[1]/h1"));
		return we;
	...
	public static WebElement doctorProfileClaimed(WebDriver d) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div[2]/div[1]/div/div/span"));
		return we;
	...
	public static WebElement doctorProfileClaimedText(WebDriver d) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div[2]/div[1]/div/div/div/p"));
		return we;
	...
	public static WebElement docRating(WebDriver d) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div[2]/div[3]/p[2]/span[1]"));
		return we;
	...
	public static WebElement docRatingCount(WebDriver d) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div[2]/div[3]/p[2]/span[2]"));
		return we;
	...
	public static WebElement docRating2(WebDriver d) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div[2]/div[3]/p[1]/span[1]"));
		return we;
	...
	public static WebElement docRatingCount2(WebDriver d) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[1]/div[2]/div[3]/p[1]/span[2]"));
		return we;
	...
	public static List<WebElement> docHospitalTimingsCount3(WebDriver d, int row) {

		List<WebElement> we = d.findElements(By.xpath(
				".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div/div[1]/div[2]/div[1]/div[1]/div"));
		return we;

	}

	public static List<WebElement> docHospitalTimingsCount4(WebDriver d, int row) {

		List<WebElement> we = d.findElements(By.xpath(
				".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[2]/div/div[1]/div"));
		return we;
	...
	public static List<WebElement> docHospitalPerDayTimingsCount3(WebDriver d, int row, int col) {

		List<WebElement> we = d.findElements(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row
				+ "]/div/div[1]/div[2]/div/div/div[" + col + "]/p[2]/span"));
		return we;

	}
	
	public static List<WebElement> docHospitalPerDayTimingsCount4(WebDriver d, int row, int col) {
	...
	public static WebElement docHospitalTimingsDay3(WebDriver d, int row, int col) {

		WebElement we = d.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row
				+ "]/div/div[1]/div[2]/div/div/div[" + col + "]/p[1]"));
		return we;

	}

	
	public static WebElement docHospitalTimingsDay4(WebDriver d, int row, int col) {

		WebElement we = d.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row
				+ "]/div/div[1]/div[2]/div/div[" + col + "]/p[1]"));
		return we;

	}
	
	public static WebElement docHospitalTimingsDay5(WebDriver d, int row, int col) {
	...
	public static WebElement docHospitalTimingsTime1(WebDriver d, int row, int col, int col2) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row
				+ "]/div/div[1]/div[2]/div/div/div[" + col + "]/p[2]/span[" + col2 + "]"));
		return we;
	...
	public static WebElement docHospitalTimingsTime2(WebDriver d, int row, int col, int col2) {
	...
	public static WebElement docHospitalTimingsTime3(WebDriver d, int row, int col, int col2) {
	...
	public static WebElement docHospitalTimingsTime4(WebDriver d, int row, int col, int col2) {
	...
	public static WebElement docHospitalTimingsTime5(WebDriver d, int row, int col, int col2) {
	...
	public static WebElement docHospitalFee(WebDriver d, int row) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div[1]/div[3]/div[1]"));
		return we;
	...
	public static WebElement docHospitalFee2(WebDriver d, int row) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div[1]/div[3]/div[1]"));
		return we;

	}

	public static WebElement docHospitalFee3(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div/div[1]/div[3]/div"));
						
		return we;

	}

	public static WebElement docHospitalFee4(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[3]/div[1]/span[1]"));
						
		return we;

	}
	
	public static WebElement docHospitalDiscountedFee(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[3]/div[1]/span[2]/span[1]"));
						
		return we;

	}
	
	public static WebElement docHospitalDiscount(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[3]/div[1]/span[2]/span[2]"));
	...
	public static WebElement docHospitalIsPrime1(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[3]/div[3]/div[1]/div[1]/span[1]"));
	...
	public static WebElement docHospitalIsPrime2(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[3]/div[2]/div[1]/div[1]/span[1]"));
	...
	public static WebElement docAwardsMoreButton(WebDriver d) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='awards and recognitions']/div[1]/span/span"));
		return we;
	...
	public static WebElement docMembershipMoreButton(WebDriver d) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='memberships']/div[1]/span/span"));
		return we;
	...
	public static WebElement docIndividualMembership(WebDriver d, int row) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='memberships']/div[2]/div[" + row + "]/div/span/span"));
		return we;
	...
	public static WebElement docIndividualRegistration(WebDriver d, int row) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='registrations']/div[2]/div[" + row + "]/div/span/span"));
		return we;
	...
	public static List<WebElement> docExpCount(WebDriver d) {
		...
		List<WebElement> we = d.findElements(By.xpath(".//*[@id='experience']/div[2]/div"));
		return we;
	...
	public static WebElement docIndividualExp(WebDriver d, int row) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='experience']/div[2]/div[" + row + "]/div/span/span"));
		return we;
	...
	public static List<WebElement> docEduCount(WebDriver d) {
		...
		List<WebElement> we = d.findElements(By.xpath(".//*[@id='education']/div[2]/div"));
		return we;
	...
	public static WebElement docIndividualEdu(WebDriver d, int row) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='education']/div[2]/div[" + row + "]/div/span/span"));
		return we;
	...
	public static WebElement docClinicMoreButton(WebDriver d) {

		WebElement we = d.findElement(By.xpath(".//*[@data-qa-id='view-more-clinics']/span"));
		return we;
	...
	public static List<WebElement> docClinicCount2(WebDriver d) {

		List<WebElement> we = d.findElements(By.xpath(".//*[@id='react-tabs-1']/div/div[1]"));
		return we;
	...
	public static WebElement docClinicName(WebDriver d, int row) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div[1]/div[1]/h2/a"));
		return we;
	...
	public static WebElement docClinicName2(WebDriver d, int row) {
		...
		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div/div[1]/div[1]/h2/a"));
		return we;

	}
	
	public static WebElement docClinicName3(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[1]/h2/a"));
		return we;
	...
	public static WebElement docClinicAdd(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div/div[1]/div[1]/p[1]"));
		return we;

	}

	public static WebElement docClinicAdd2(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[1]/p[1]"));
		return we;
	...
	// Clinic Google Address

	public static WebElement docClinicGoogleAdd(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[1]/div[1]/p[2]/a"));
		return we;

	}

	public static WebElement docClinicGoogleAdd2(WebDriver d, int row) {

		WebElement we = d.findElement(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div/div[1]/div[1]/p[2]/a"));
		return we;
	...
	public static WebElement docBookingText3(WebDriver d, int row) {

		WebElement we = d
				.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[2]/div/button/span[2]"));
		return we;						
	...
	public static WebElement docBookingText4(WebDriver d, int row) {

		WebElement we = d
				.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[2]/div/button/span/span"));
		return we;						

	}

	// For Call Now Mobile Number
		public static WebElement docClinicNumber(WebDriver d, int row) {

			WebElement we = d
					.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div/div[3]/div/div/div[2]"));
			return we;						

		}

		
		public static WebElement docClinicNumber2(WebDriver d, int row) {

			WebElement we = d
					.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div/div[" + row + "]/div/div[3]/div/div/div[2]"));
			return we;						
