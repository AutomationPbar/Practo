...
public class PractoURLsCompleteData {
					...
					Thread.sleep(3000);
								...
								/*		String parentWin = d.getWindowHandle();
										...
										if (handles2.size() > 1) {
											...
											// d.switchTo().window(handles2.get(1));
								 	...
								 	*/
										...
										if (rat == 0) {
											...
											try {
												rating = wait
														.until(ExpectedConditions.visibilityOf(PractoPOM.docRating2(d)))
														.getText();
										...
										if (rat1 == 0) {
											try {
												ratingVotes = wait.until(
														ExpectedConditions.visibilityOf(PractoPOM.docRatingCount2(d)))
														.getText();
	...
	d.navigate().to(baseURL);Thread.sleep(3000);
