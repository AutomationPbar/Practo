...
public class PractoDoctorsPrime {
	...
	/*		suggestions.add("Bangalore");
			...
			for (int i = 0; i < suggestions.size(); i++) {
				...
				try {
					...
					String isPrimeIdentifier = "";

					try {

						isPrimeIdentifier = wait
								.until(ExpectedConditions.visibilityOf(d.findElement(
										By.xpath(".//*[@id='container']/div[3]/div/div[2]/div[1]/div[2]/div[1]/span"))))
								.getText();
					...
					if (isPrimeIdentifier.contains("Prime")) {

						String pageURL1 = pageURL + "?program_type=practo_prime";
						
						d.navigate().to(pageURL1);
						...
						try {
							...
							totalDocCount = wait
									.until(ExpectedConditions.visibilityOf(PractoPOM.totalDocCountPerCity(d)))
									.getText();
						 ...
						 * 
						 * docsPerPage1 =
						 * PractoPOM.doctorCountPerPage(d).size();
						 * 
							...
							try {
								...
								try {
									...
									if (!currURL.contains("?page")) {
										...
										navigateToURL = currURL + "?page=" + (k) + "&program_type=practo_prime";

									} else {

										navigateToURL = currURL + (k) + "&program_type=practo_prime";
									...
									for (int l = 1; l <= (docsPerPage + 1); l++) {
										...
										try {
											...
											try {
												...
												DocImage = wait
														.until(ExpectedConditions
																.visibilityOf(PractoPOM.doctorImage(d)))
														.getAttribute("src");
											...
											try {
												...
												rating = wait
														.until(ExpectedConditions.visibilityOf(PractoPOM.docRating(d)))
														.getText();
											...
											if (rat == 0) {
												...
												try {
													rating = wait.until(
															ExpectedConditions.visibilityOf(PractoPOM.docRating2(d)))
															.getText();
											...
											try {
												...
												ratingVotes = wait.until(
														ExpectedConditions.visibilityOf(PractoPOM.docRatingCount(d)))
														.getText();
												rat1 = 1;
											...
											if (rat1 == 0) {
												try {
													ratingVotes = wait
															.until(ExpectedConditions
																	.visibilityOf(PractoPOM.docRatingCount2(d)))
															.getText();
											...
											try {
												...
												aboutText = wait.until(
														ExpectedConditions.visibilityOf(PractoPOM.aboutDoctor(d)))
														.getText();
													...
													if (posFrame != 2) {
														...
														for (int g = 1; g <= docCountinClinic; g++) {
															...
															try {
																...
																System.out.println(
																		"Clinic Doctor URL 1: " + clinicDocURL);

																if (clinicDocURL.contains("?")) {

																	int indexOfParam = clinicDocURL.indexOf("?");

																	clinicDocURL = clinicDocURL.substring(0,
																			indexOfParam);

																	System.out.println(
																			"Clinic Doctor URL : " + clinicDocURL);
																...
																System.out.println(
																		"Final Clinic Name : " + clinicDocName);
																// Get Linked
																// Doc/Clinic
																// Booking
																...
																try {
																	...
																	try {
																		...
																		timeCount = PractoPOM
																				.docHospitalTimingsCount(d, g).size();
														...
														for (int f = 1; f <= docCountinClinic; f++) {
															...
															try {
																...
																System.out.println(
																		"Final Clinic Namee : " + clinicDocName);
																...
																try {
																	...
																	try {
																		...
																		timeCount = PractoPOM
																				.docHospitalTimingsCount2(d, g).size();
											...
											try {
												...
												try {
													...
													wait.until(ExpectedConditions
															.visibilityOf(PractoPOM.docSpecMoreButton(d))).click();
												...
												if (servicesCount >= 1) {
													...
													for (int g = 1; g <= servicesCount; g++) {
														...
														try {
															...
															String individualService = wait
																	.until(ExpectedConditions.visibilityOf(
																			PractoPOM.docIndividualSpec(d, g)))
																	.getText();
												...
												if (servicesCount >= 1) {
													...
													for (int g = 1; g <= servicesCount; g++) {
														...
														try {
															...
															String individualService = wait
																	.until(ExpectedConditions.visibilityOf(
																			PractoPOM.docIndividualAward(d, g)))
																	.getText();
											...
											try {
												...
												try {
													...
													wait.until(ExpectedConditions
															.visibilityOf(PractoPOM.docEduMoreButton(d))).click();
												...
												if (servicesCount >= 1) {
													...
													for (int g = 1; g <= servicesCount; g++) {
														...
														try {
															...
															String individualService = wait
																	.until(ExpectedConditions.visibilityOf(
																			PractoPOM.docIndividualEdu(d, g)))
																	.getText();

															int indexOfComma = individualService.lastIndexOf(",");

															String year = individualService.substring(
																	(indexOfComma + 2), individualService.length());

															int indexOfHyphen = individualService.lastIndexOf("-");

															String Ins = individualService
																	.substring((indexOfHyphen + 2), indexOfComma);
											...
											try {
												...
												try {
													...
													wait.until(ExpectedConditions
															.visibilityOf(PractoPOM.docExpMoreButton(d))).click();
												...
												if (servicesCount >= 1) {
													...
													for (int g = 1; g <= servicesCount; g++) {
														...
														try {
															...
															String individualService = wait
																	.until(ExpectedConditions.visibilityOf(
																			PractoPOM.docIndividualExp(d, g)))
																	.getText();
											...
											try {
												...
												healthFeedCount = String
														.valueOf(PractoPOM.healthFeedCount(d, 7).size());
											...
											try {
												...
												dbm.SetPractoLabData(docCity, Name, jsonData, remarks, doctorNameURL,
														rating, ratingVotes, isPrime, tableName);
