...
public class PractoPOM {
	...
	public static List<WebElement> docHospitalTimingsCount(WebDriver d, int row) {
		...
		List<WebElement> we = d.findElements(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[" + row + "]/div[1]/div[2]/div/div/div"));
		return we;
	...
	public static List<WebElement> docHospitalTimingsCount2(WebDriver d, int row) {
		...
		List<WebElement> we = d.findElements(
				By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div[1]/div[2]/div/div/div"));
		return we;
	...
	public static List<WebElement> docHospitalPerDayTimingsCount(WebDriver d, int row, int col) {
		...
		List<WebElement> we = d.findElements(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[" + row
	...
	public static List<WebElement> docHospitalPerDayTimingsCount2(WebDriver d, int row, int col) {
		...
		List<WebElement> we = d.findElements(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div[1]/div[2]/div/div/div[" + col + "]/p[2]/span"));
		return we;
	...
	public static WebElement docHospitalTimingsDay2(WebDriver d, int row, int col) {
		...
		WebElement we = d.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div[1]/div[2]/div/div/div[" + col + "]/p[1]"));
		return we;
	...
	public static WebElement docHospitalFee(WebDriver d, int row) {
		...
		WebElement we = d
				.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[" + row + "]/div[1]/div[3]/div[1]"));
		return we;
	...
	public static List<WebElement> docClinicCount(WebDriver d) {
		...
		List<WebElement> we = d.findElements(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div"));
		return we;
	...
	public static WebElement docClinicName(WebDriver d, int row) {
		...
		WebElement we = d
				.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[" + row + "]/div[1]/div[1]/h2/a"));
		return we;						
	...
	public static WebElement docClinicName2(WebDriver d, int row) {
		...
		WebElement we = d
				.findElement(By.xpath(".//*[@id='react-tabs-1']/div/div[1]/div/div[2]/div[" + row + "]/div[1]/div[1]/h2/a"));
		return we;						
