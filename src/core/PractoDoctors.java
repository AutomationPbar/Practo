								...
								for (int l = 1; l <= docsPerPage; l++) {
									...
									try {
											...
											if (servicesCount >= 1) {
												...
												for (int g = 1; g <= servicesCount; g++) {
													...
													try {
														...
														System.out.println("Specs " + g + ":" + individualService);
										...
										try {
											...
											System.out.println("Awards Count : " + servicesCount);
										...
										try {
											...
											System.out.println("Memberships Count : " + servicesCount);
											...
											if (servicesCount >= 1) {
												...
												for (int g = 1; g <= servicesCount; g++) {
													...
													try {
														...
														System.out.println("Membership " + g + ":" + individualService);
										...
										try {
											...
											System.out.println("Registration Count : " + servicesCount);
											...
											if (servicesCount >= 1) {
												...
												for (int g = 1; g <= servicesCount; g++) {
													...
													try {
														...
														System.out
																.println("Registration " + g + ":" + individualService);
											...
											if (servicesCount >= 1) {
												...
												for (int g = 1; g <= servicesCount; g++) {
													...
													try {
														...
														System.out.println("Service Edu" + g + ":" + individualService);
											...
											if (servicesCount >= 1) {
												...
												for (int g = 1; g <= servicesCount; g++) {
													...
													try {
														...
														System.out.println("Service Exp" + g + ":" + individualService);
